...
mongoose
  .connect('mongodb+srv://mtunzi:MongoDBJune2021.@firstcluster21.ik5m1.mongodb.net/shop?retryWrites=true&w=majority') //connected to shop db in firstcluster21 of db user mtunzi with specified password "MongoDBJune2021."
  .then(result => {
